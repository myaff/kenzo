(function() {
    ...
    window.CanvasSlideshow = function( options ) {
      ...
      options.closestContainer = options.hasOwnProperty('closestContainer') ? options.closestContainer : document.body;
      ...
      this.initPixi = function() {
        ...
        options.closestContainer.appendChild( renderer.view );
